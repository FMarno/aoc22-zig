...
pub fn build(b: *std.build.Builder) void {
    ...
    add_day(&build_info, "six");
    add_day(&build_info, "seven");
    add_day(&build_info, "eight");
    add_day(&build_info, "nine");
    add_day(&build_info, "ten");
    add_day(&build_info, "eleven");
    add_day(&build_info, "twelve");
    add_day(&build_info, "thirteen");
    add_day(&build_info, "fourteen");
    add_day(&build_info, "fifteen");
    add_day(&build_info, "sixteen");
    add_day(&build_info, "seventeen");
}
